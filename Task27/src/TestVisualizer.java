...
public class TestVisualizer implements Runnable {
	...
	*/
	...
	BubbleSortRecursive bsr = new BubbleSortRecursive(av);
	Thread t4 = new Thread(bsr);
	t4.start(); 
	
	
	/*
	InsertionSortRecursive isr = new InsertionSortRecursive(av);
	Thread t5 = new Thread (isr);
	t5.start(); 
	*/
